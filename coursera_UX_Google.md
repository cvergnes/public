...
Good UX :
- usable  including accessibility
- equitable
- enjoyable
- useful
...
- Visual designers : focus on how the product or technology looks, design logos, illustration, icons and decide font colour, sire or layouts.
...
- UX writers think about how to make the language within a product clearer so that the user experience is more intuitiUX writers also help define a brand’s voice and personality
...
- Production designers : marke sure first and final decisions match in finished product ans assts to be ready hand off to the engineering team
...
Icons are usually better than text : it saves space, pleasing to look and easy too understand (quel que soit la langue de l’utilisateur). But if meaning is difficult use text. Bad UX : add sth to your shopping cart and see it out out of stock when buying it. 
        
#### Characteristics of a good UX : 

- Usable : purpose of the product is clear and it’s easy to use
...
#### five elements of UX design
                ...
                [https://medium.com/omarelgabrys-blog/ux-a-quick-glance-about-the-5-elements-of-user-experience-part-2-a0da8798cd52](https://medium.com/omarelgabrys-blog/ux-a-quick-glance-about-the-5-elements-of-user-experience-part-2-a0da8798cd52)
...
### Design across platforms
            ...
            ****The four Cs of designing for multiple platforms :**** 
            ...
            - **Complementary: o**ne way to create a great cross-platform user experience is to make sure that the design of each platform adds something new for the user
...
### What are design sprints ?
            ...
            1. Understand phase : learn from experts, conversations to understand users (users come first
